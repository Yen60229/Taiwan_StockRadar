...
| 日期 | 備份檔 | 結果 | RTO | 備註 |
|---|---|---|---|---|
| 2026-09-06 | `stockradar_20260906_163054.dump`（1.9M） | ✅ 通過 | **3 秒** | 第一次演練，滿足 ADR-10 gate。7 張表 row count 與最新日期全數一致（daily_quotes 85,394 / institutional_flow 51,814 / stocks 1,993）|
